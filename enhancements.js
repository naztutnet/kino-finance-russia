(() => {
  ...
  function ensureStyles() {
    for (const href of ['product.css?v=2026081106', 'product-home.css?v=2026081106', 'white-theme.css?v=2026081107', 'approved-home.css?v=2026081121', 'header-system.css?v=2026081104', 'heading-system.css?v=2026081123', 'readability-system.css?v=2026081201', 'motion-system.css?v=2026081201', 'theme-system.css?v=2026081201']) {
    ...
    const motionStyles = [...document.querySelectorAll('link[rel="stylesheet"]')].find(link => link.href.includes('motion-system.css'));
    if (motionStyles) document.head.append(motionStyles);
    const themeStyles = [...document.querySelectorAll('link[rel="stylesheet"]')].find(link => link.href.includes('theme-system.css'));
    if (themeStyles) document.head.append(themeStyles);
  }
